...
public class AXmlResourceParser {
	...
	public final static int START_DOCUMENT = 3;
	public final static int END_DOCUMENT = 4;
	...
	public void require(int type, String namespace, String name)
		...
		if (type != getEventType()
			...
			throw new IOException(" is expected.");
		}
	}
...
final class IntReader {
	...
	public int readInt() throws IOException {
		...
		System.out.println("idx="+String.valueOf(idx++) + " v="+Integer.valueOf(result));
		return result;
	}
...
class StringBlock {
	...
	public String getString(int index) {
		...
		System.out.println("GetString idx="+index+"offset="+offset+"length="+length+str);
		return str;
	}
